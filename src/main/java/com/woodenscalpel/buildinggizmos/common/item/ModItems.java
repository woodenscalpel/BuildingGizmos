...
public class ModItems {
    ...
    public static final RegistryObject<Item> BUILDWAND= ITEMS.register("buildwand", () -> new BuildWand(new BuildWand.Properties().tab(ModCreativeModeTab.TAB_BUILDINGGIZMOS)));
