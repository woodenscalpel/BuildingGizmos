...
//keycodes
    ...
    private void drawTexture(PoseStack poseStack, int interpolatedx, int interpolatedy,int interpolatedz, Block block, Direction direction) {
            ...
            poseStack.pushPose();
            poseStack.scale(2*arbitraryscale,1*arbitraryscale,1);
            //blit(poseStack, interpolatedx/2, interpolatedy, (int) (int3 / ratio), (int) (int5 / ratio), usize, vsize);
            blit(poseStack, (int) (interpolatedx/(2*arbitraryscale)), (int) (interpolatedy/arbitraryscale), interpolatedz, int3/ratio, int5/ratio, usize, vsize, 256, 256);
            poseStack.popPose();
