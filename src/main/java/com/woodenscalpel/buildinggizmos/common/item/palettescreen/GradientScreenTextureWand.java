...
public class GradientScreenTextureWand extends Screen {
    ...
    Block selectedBlock;
    Block searchResult;
    public GradientScreenTextureWand(Component pTitle) {
        super(pTitle);
    }
    ...
    protected void init() {
        ...
        //this.explorerWidget = new ExplorerWidget(x1,y1,explorerdimension,explorerdimension,Component.nullToEmpty("PaletteExplorer"),paletteData,this);
